...
How are the price list configured?
"""
...
class Player(BasePlayer):
    ...
    # For Curiosity page (LL)
    mpl_WTP              = models.FloatField ()
    curiosity_random_num = models.FloatField ()
    curiosity_reveal     = models.BooleanField()
    payoff_lottrey       = models.CurrencyField ()
    ...
    def set_payoffs(self):
        ...
        # set player's payoff
        # -----------------------------------------------------------------------------------------------------
        # Draw the lottery for payment, at random
