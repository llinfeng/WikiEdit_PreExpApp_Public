...
class Constants(BaseConstants):
    ...
    lottery_b_hi = 100
    lottery_b_lo = 10
    # 2020-10-20: note, the original parameter values were agreeing with Holt and Laury (2002). Yet, when rendered, the numbers are rounded to the integer. We reuse the MobLab parameters here.
